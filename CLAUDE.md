...
_Последнее обновление: 2026-04-29 (фидбэк-flow после Deal — облако и рейтинг живые)_
...
1. **`/my_posts` + 14-дневный auto-expire** — список своих объявлений с быстрым «Закрыть». Шедулер раз в сутки помечает старые approved как expired. Аркадий подтвердил «раз в сутки достаточно».
