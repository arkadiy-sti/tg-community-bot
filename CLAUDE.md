...
_Последнее обновление: 2026-05-11 (group write restriction: только Coworker/Customer могут писать; баннер в /start; тексты обновлены без Гость; **109 тестов зелёных**)_
